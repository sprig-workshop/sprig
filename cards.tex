...
\card{\includegraphics[height=8mm]{img/logo/reality}#1}{#2}{#3}{#4}{RealityBlue}{Domain explanation}
}

\newcommand{\MeaningCard}[4]{
\card{#1 \includegraphics[height=8mm]{img/logo/meaning}}{#2}{#3}{#4}{MeaningYellow}{Domain explanation}
}

\newcommand{\TechnologyCard}[4]{
\card{#1 \includegraphics[height=8mm]{img/logo/technology}}{#2}{#3}{#4}{TechnologyRed}{Medium explanation}
}
...
Games on gaming-consoles are typically played with a hand held controller.
...
Interactive Devices © 2012 Disney Research%
}{%
By using screens, sensors, and the Internet any surface can become a video-game!
An ordinary board-game can be transformed into a new digital one with many more opportunities. %
}
%
\TechnologyCard{
Mobile%
...
With “everyone” owning a smart phone, it is also natural to play games on it.
...
\todo[inline]{change to a combination of tamagotci, guitar hero, nintendo labo, and joystic}
